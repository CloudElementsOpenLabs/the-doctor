...
commander
  ...
  .option("-n, --name [name]", "name of specific entity or multiple comma-separated entities to be download")
  ...
  .on('--help', () => {
    ...
    console.log('    $ doctor download vdrs staging -n vdr1,vdr2,vdr3 -D ~/Desktop/vdrs/')
