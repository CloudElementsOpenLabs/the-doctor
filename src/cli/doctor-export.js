...
commander
  ...
  .option("-n, --name [name]", "name of specific entity or multiple comma-separated entities to be export")
  ...
  .on('--help', () => {
    ...
    console.log('    $ doctor export vdrs staging -n vdr1,vdr2,vdr3 -D ~/Desktop/vdrs/')
